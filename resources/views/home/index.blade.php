                    ...
                    <div class="navbar-inner navbar-inner2">
                        ...
                        <div class="header-action-items header-action-items1">
                            ...
                            <div class="cart action-item">
                                <div class="cart-nav">
                                    <div class="#"><a href="{{ route('index') }}"><i class="rt-cart"></i></a><span
                        ...
                        <div class="rts-menu">
                            <nav class="menus menu-toggle">
                                <ul class="nav__menu">
                                    ...
                                    <li><a class="menu-item" href="https://maktechsolution.com/">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
            ...
            <div class="offset-sidebar-main">
                <div class="offset-widget mb-40">
                    <div class="info-widget">
                        <img src="{{ asset('assets/images/mts.webp') }}" alt="">
                        <p class="mb-30">
    ...
    <div class="rts-recent_products-section section-gap">
        <div class="container">
            ...
            <div class="d-flex justify-content-center">
                <a href="{{ route('index') }}" class="all-products-link">All products <i
                                ...
                                <div class="email contact-item">
                                    ...
                                    <div class="contact-info">
                                        <a href="mailto:pixcelsthemes@gmail.com"
                                            class="email-address info">info@maktechsolution.com</a>
